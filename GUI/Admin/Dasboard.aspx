<%@ Page Title="" Language="C#" MasterPageFile="~/Admin/Publicpage.Master" AutoEventWireup="true" CodeBehind="Dasboard.aspx.cs" Inherits="GUI.Admin.Dasboard" %>
  ...
  <div id="content-header">
    ...
    <div class="row-fluid">
      <div class="span12">
       ...
       <asp:GridView class="table table-bordered table-striped" ID="grvDanhsachsanpham" runat="server" AutoGenerateColumns="False" Height="210px" Width="706px">
           <Columns>
