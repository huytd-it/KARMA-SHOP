<%@ Page Title="" Language="C#" MasterPageFile="~/Admin/Publicpage.Master" AutoEventWireup="true" CodeBehind="Quanlisanpham.aspx.cs" Inherits="GUI.Admin.Dasboard" %>
    ...
    <div class="row-fluid">
      <div class="span12">
          <div class="widget-title"> <span class="icon"> <i class="icon-th"></i> </span>
            <h5>Quan lí sản phẩm</h5>
          </div>
        <div class="widget-content nopadding">
       <asp:GridView class="table table-bordered table-striped" ID="grvDanhsachsanpham" runat="server" AutoGenerateColumns="False" Height="210px" Width="706px" OnRowCommand="grvDanhsachsanpham_RowCommand">
           <Columns>
...
<ControlStyle Height="50px" Width="100px"></ControlStyle>
               ...
               <asp:BoundField DataField="namsx" HeaderText="năm sản xuất" SortExpression="namsx" />
                <asp:TemplateField>
                   <ItemTemplate>
                        <asp:LinkButton CssClass="btn btn-info btn-mini" ID="btnchon" runat="server" CausesValidation="false" Text="Chọn " CommandArgument='<%# Eval("id") %>' PostBackUrl='<%#Eval("id","Chitietsp.aspx?id={0}")%>' />                       
               ...
               <asp:TemplateField ShowHeader="false">
                   <ItemTemplate>
                       <asp:LinkButton CssClass="btn btn-danger btn-mini" ID="btnXoa" runat="server" CausesValidation="false" Text="Xoa" OnClientClick="return confirm('Ban co chac muon xoa?');" CommandName="XoaSP" CommandArgument='<%# Eval("id") %>'></asp:LinkButton>
                   </ItemTemplate>
               </asp:TemplateField>
