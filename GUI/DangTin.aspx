            ...
            <div class="breadcrumb-banner d-flex flex-wrap align-items-center justify-content-end">
                <div class="col-first">
                    ...
                    <nav class="d-flex align-items-center">
                        <asp:HyperLink ID="hplHome" runat="server" NavigateUrl="~/Index.aspx">TrangChủ<span class="lnr lnr-arrow-right"></span></asp:HyperLink>
                        <asp:HyperLink ID="hblRegister" runat="server" Text="Đăng kí" NavigateUrl="~/Register.aspx"></asp:HyperLink>
                    </nav>
                </div>
            </div>
        </div>
